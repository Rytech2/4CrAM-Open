...
enum _sp {
	...
	// 4th Job Trait Stats/Sub-Stats, Trait Points, and Activity Points
	SP_POW = 219,
	SP_STA,
	SP_WIS,
	SP_SPL,
	...
	SP_WEAPON_SUBSIZE = 3000// 4CrAM needed. Keeping the rest of the 2000 range open for rAthena. [Rytech]
};
